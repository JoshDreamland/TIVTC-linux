...
__declspec(align(16)) const __int64_t onesMask[2] = { 0xFFFFFFFFFFFFFFFF, 0xFFFFFFFFFFFFFFFF };
__declspec(align(16)) const __int64_t onesByte[2] = { 0x0101010101010101, 0x0101010101010101 };
__declspec(align(16)) const __int64_t twosByte[2] = { 0x0202020202020202, 0x0202020202020202 };
__declspec(align(16)) const __int64_t twosWord[2] = { 0x0002000200020002, 0x0002000200020002 };
__declspec(align(16)) const __int64_t foursByte[2] = { 0x0404040404040404, 0x0404040404040404 };
__declspec(align(16)) const __int64_t eightsByte[2] = { 0x0808080808080808, 0x0808080808080808 };
__declspec(align(16)) const __int64_t sixteensByte[2] = { 0x1010101010101010, 0x1010101010101010 };
__declspec(align(16)) const __int64_t thirtytwosByte[2] = { 0x2020202020202020, 0x2020202020202020 };
__declspec(align(16)) const __int64_t threeWord[2] = { 0x0003000300030003, 0x0003000300030003 };
__declspec(align(16)) const __int64_t sixteenWord[2] = { 0x0010001000100010, 0x0010001000100010 };
__declspec(align(16)) const __int64_t nineteenWord[2] = { 0x0013001300130013, 0x0013001300130013 };
